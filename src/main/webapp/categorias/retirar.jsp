                ...
                <div class="card-body">
                    <form method="post" action="CategoriaController?accion=guardar">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2">Cantidad a retirar</label>
                            <input type="text" name="txtRetiro"
                                   id="txtNombreCategoria" maxlength="50" 
                                   placeholder="$00.000" 
                                   class="form-control" required="required" 
                                   value="<c:out value="${categoria.entidad.retirar}"/>" 
                            />
                        </div>
